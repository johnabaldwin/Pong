...
# Push button 0 -> Right
set_property -dict { PACKAGE_PIN D19 IOSTANDARD LVCMOS33 } [get_ports right_p1]
# Push button 1 -> Left
set_property -dict { PACKAGE_PIN D20 IOSTANDARD LVCMOS33 } [get_ports left_p1]

# Push button 2 -> Right
set_property -dict { PACKAGE_PIN L20 IOSTANDARD LVCMOS33 } [get_ports right_p2]
# Push button 3 -> Left
set_property -dict { PACKAGE_PIN L19 IOSTANDARD LVCMOS33 } [get_ports left_p2]
